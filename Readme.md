...
| MaxBackFillDurationMinutes | On the first invocation of this function, this much 'minutes' old logs will be polled.                                                                                                                                                      | 30                                                                                                                 |
...
| FunctionMemorySize         | The memory size for the OKTA Log Collector lambda function in MBs                                                                                                                                                                           | 256                                                                                                                |
